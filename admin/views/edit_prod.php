...
<body>
    <?php
        require_once "../controllers/edit_prod.php";
    ?>

    <div class="container user">
        <h1>Sửa sản phẩm</h1> 
        <hr>
        <form action="../controllers/edit_prod.php" method="post" enctype="multipart/form-data">
            <div class="box sgl">
            ...
            <div class="box img">
                ...
                <div class="right-site">
                    <?php
                        if(isset($_SESSION['images_prod'])) {
                            $images_prod = explode(',', $_SESSION['images_prod']);
